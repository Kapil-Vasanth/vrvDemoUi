...
function SignUpPage() {
  return (
    <div className="min-h-screen m-auto flex flex-col justify-center items-center gap-6  from-cyan-500 to-blue-500  h-full bg-[url('https://preline.co/assets/svg/component/rounded-lines.svg')] bg-no-repeat bg-cover ">
        <h1 className="bg-clip-text bg-gradient-to-l from-purple-400 to-blue-600 text-transparent text-7xl font-bold">
        VRV Security
      </h1>
    <div class="md:w-[500px] sm:w-[200px] bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
